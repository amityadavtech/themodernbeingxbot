  ...
  return (
    <section className="bg-[#1A1A1A] p-4 md:p-12 rounded-2xl shadow-2xl text-white mt-10 space-y-10">
      ...
      <p className="text-center text-gray-300 max-w-2xl mx-auto">
        At <strong className="text-[var(--primary-color)]">BeingxBot</strong>, we deliver powerful digital solutions tailored to your business growth.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {features.map(({ Icon, title, desc }, i) => (
          <motion.div
            ...
            className="highlight-effect bg-[#222] p-6 rounded-lg shadow-md border-2 border-transparent hover:border-[var(--primary-color)] hover:shadow-[0_0_15px_var(--primary-color)] transition-all flex flex-col items-center gap-4"
          >
